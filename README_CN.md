...
- **Wiki 整理脚本** — 一键将 LLM 放错位置的根目录文件批量移动到正确的分类目录。[脚本](scripts/reorganize-wiki.cjs) · [使用说明](scripts/README.md)
...
- **Windows**: [Trading Review Wiki_0.6.7_x64-setup.exe](https://github.com/ymj8903668-droid/trading-review-wiki/releases/latest)
...
- **Wiki 整理脚本** —— 批量修复被 LLM 错误放到 wiki 根目录的文件，自动按 frontmatter type 归类到正确目录（[脚本](scripts/reorganize-wiki.cjs) · [使用说明](scripts/README.md)）
